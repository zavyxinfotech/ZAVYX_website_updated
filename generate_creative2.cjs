...
if (!code.includes("currentServiceKey === 'branding-creative'")) {
  code = code.replace(
...
code = code.replace("import { \n", "import { Layout, Compass, ShoppingBag, ShieldCheck, Rocket, \n");

fs.writeFileSync("src/pages/ServiceDetail.jsx", code);
console.log("BrandingCreativeView injection complete.");
