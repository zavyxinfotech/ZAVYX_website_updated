function WhatsAppApiBotsView() {
  ...
  return (
    <div className="bg-slate-50/50 dark:bg-[#050B14] text-slate-900 dark:text-slate-50 min-h-screen transition-colors duration-300 font-sans pb-16 relative overflow-hidden">
        ...
        <div className="max-w-[1350px] w-full mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <ScrollSlideSection direction="up" className="lg:col-span-6 flex flex-col text-left max-w-xl lg:max-w-2xl">
              ...
              {/* Startup Metrics Row */}
              <div className="grid grid-cols-4 gap-4 pt-4 border-t border-slate-200/60 dark:border-slate-800/60">
                <div>
                  <div className="text-xl sm:text-2xl font-normal text-slate-900 dark:text-white tracking-tight">10M+</div>
                  <div className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 font-normal">Messages Processed</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-normal text-slate-900 dark:text-white tracking-tight">500+</div>
            ...
            <ScrollSlideSection direction="up" delay="100ms" className="lg:col-span-6 relative flex justify-center">
              <div className="relative w-full max-w-[620px] aspect-[4/3] rounded-3xl p-6 border-0 flex items-center justify-center overflow-visible">
                {/* Visual Chat Mock */}
                <div className="relative w-full max-w-[500px] bg-slate-900 rounded-xl shadow-2xl flex border border-slate-800 overflow-hidden transform group-hover:scale-105 transition-transform duration-500 z-10">
                  {/* Left Sidebar */}
                ...
                <div className="absolute top-0 right-4 bg-white dark:bg-slate-800 border-0 shadow-lg rounded-xl p-2.5 flex items-center gap-2.5 z-20 hover:scale-105 transition-transform duration-300">
                  ...
                  <div>
                    ...
                    <span className="text-[9px] text-emerald-500 block leading-tight mt-0.5">Connected</span>
                  </div>
                </div>

                <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 shadow-lg rounded-xl p-3 flex flex-col z-20 scale-90 sm:scale-100">
                  ...
                  <div className="flex gap-4 items-end">
                    ...
                    <div>
                      <div className="text-sm font-bold text-emerald-500 flex items-center gap-1"><ArrowUpRight className="w-3 h-3" /> 32%</div>
        ...
        <ScrollSlideSection direction="up" className="mb-10 text-left">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-base sm:text-lg max-w-lg font-normal">
              We design and implement WhatsApp solutions that help you automate, engage, and grow — tailored to your business needs.
            </p>
          </div>
        </ScrollSlideSection>
      ...
      {/* 3. HOW IT WORKS */}
      <section className="py-12 sm:py-16 max-w-[1350px] mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="bg-white dark:bg-slate-800/50 rounded-3xl p-8 sm:p-10 shadow-sm">
          <ScrollSlideSection direction="up" className="mb-10 text-left">
            <h4 className="text-sky-600 dark:text-sky-400 font-normal tracking-widest text-xs sm:text-sm uppercase mb-2">
              HOW IT WORKS
            </h4>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-base sm:text-lg max-w-lg font-normal">
                A seamless workflow that turns conversations into customers.
              </p>
            </div>
          </ScrollSlideSection>

          {/* Interactive Flowchart exactly as in WhatsApp mock */}
          <div className="relative overflow-x-auto custom-scrollbar pb-6 mt-8">
            <div className="min-w-[900px] flex items-stretch justify-between relative px-2">
               ...
               <div className="relative z-10 flex flex-col items-center w-1/5">
                 <div className="text-sm font-bold text-slate-700 dark:text-slate-200 mb-4 bg-white dark:bg-slate-800 px-2">1. Customer Message</div>
                 <div className="bg-transparent border border-slate-200 dark:border-slate-700 rounded-xl p-3 shadow-sm w-[90%] bg-white dark:bg-slate-800 flex items-start gap-3 relative h-28 transform transition-transform hover:-translate-y-1">
                   <div className="w-8 h-8 rounded-full bg-slate-200 dark:bg-slate-700 shrink-0 overflow-hidden">
                     {/* avatar placeholder */}
                   </div>
                   <div className="bg-slate-100 dark:bg-slate-700/50 rounded-xl rounded-tl-none p-2 text-[10px] text-slate-700 dark:text-slate-300 font-medium">
                     Hi! I'm interested in your services.
                   </div>
                   <ArrowRight className="absolute -right-6 top-1/2 -translate-y-1/2 w-4 h-4 text-sky-400 hidden lg:block" />
                 </div>
               </div>

               {/* Step 2 */}
               <div className="relative z-10 flex flex-col items-center w-1/5">
                 <div className="text-sm font-bold text-slate-700 dark:text-slate-200 mb-4 bg-white dark:bg-slate-800 px-2">2. WhatsApp API</div>
                 <div className="bg-transparent border border-slate-200 dark:border-slate-700 rounded-xl p-3 shadow-sm w-[90%] bg-white dark:bg-slate-800 flex flex-col items-center gap-2 relative h-28 transform transition-transform hover:-translate-y-1">
                   <div className="w-10 h-10 rounded-full bg-emerald-100 text-emerald-500 flex items-center justify-center">
                     <MessageCircle className="w-6 h-6 fill-current" />
                   </div>
                   <div className="text-[10px] text-slate-600 dark:text-slate-400 text-center font-medium">Secure connection via WhatsApp Business API</div>
                   <ArrowRight className="absolute -right-6 top-1/2 -translate-y-1/2 w-4 h-4 text-sky-400 hidden lg:block" />
                 </div>
               </div>
               ...
               {/* Step 3 */}
               <div className="relative z-10 flex flex-col items-center w-1/5">
                 <div className="text-sm font-bold text-slate-700 dark:text-slate-200 mb-4 bg-white dark:bg-slate-800 px-2">3. Bot / Automation</div>
                 <div className="bg-transparent border border-slate-200 dark:border-slate-700 rounded-xl p-3 shadow-sm w-[90%] bg-white dark:bg-slate-800 flex flex-col items-center gap-2 relative h-auto min-h-[112px] transform transition-transform hover:-translate-y-1">
                   <div className="w-8 h-8 text-sky-500 flex items-center justify-center mb-1">
                     <Bot className="w-8 h-8" />
                   </div>
                   <ul className="text-[9px] text-slate-600 dark:text-slate-400 w-full text-left space-y-1 font-medium">
               ...
               {/* Step 4 */}
               <div className="relative z-10 flex flex-col items-center w-1/5">
                 <div className="text-sm font-bold text-slate-700 dark:text-slate-200 mb-4 bg-white dark:bg-slate-800 px-2">4. CRM System</div>
                 <div className="bg-transparent border border-slate-200 dark:border-slate-700 rounded-xl p-3 shadow-sm w-[90%] bg-white dark:bg-slate-800 flex flex-col items-center gap-2 relative h-auto min-h-[112px] transform transition-transform hover:-translate-y-1">
               ...
               {/* Step 5 */}
               <div className="relative z-10 flex flex-col items-center w-1/5">
                 <div className="text-sm font-bold text-slate-700 dark:text-slate-200 mb-4 bg-white dark:bg-slate-800 px-2">5. Human Agent (If Needed)</div>
                 <div className="bg-transparent border border-slate-200 dark:border-slate-700 rounded-xl p-3 shadow-sm w-[90%] bg-white dark:bg-slate-800 flex items-center gap-3 relative h-28 transform transition-transform hover:-translate-y-1">
                   <div className="w-8 h-8 rounded-full bg-slate-200 dark:bg-slate-700 shrink-0 overflow-hidden">
                     {/* avatar placeholder */}
                   </div>
                   <div className="bg-sky-50 dark:bg-sky-900/40 border border-sky-100 dark:border-sky-800 rounded-xl rounded-tl-none p-2 text-[10px] text-slate-700 dark:text-slate-300 font-medium">
      ...
      <section className="py-12 sm:py-16 max-w-[1350px] mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <ScrollSlideSection direction="up" className="mb-10 text-left">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[2.6rem] font-normal tracking-tight text-slate-900 dark:text-white max-w-xl mb-4">
        ...
        <ScrollSlideSection direction="up" delay="100ms" className="lg:absolute lg:top-12 lg:right-12 lg:w-[60%]">
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
               <div className="flex flex-col gap-2">
                 ...
                 <div className="relative h-24 w-full flex items-end gap-1.5 justify-between">
                    <div className="absolute top-2 right-0 bg-sky-500 text-white text-[9px] px-1.5 py-0.5 rounded shadow">12.4K</div>
      ...
      {/* spacer to accommodate absolute dashboard on lg screens */}
      ...
      <section className="py-12 sm:py-16 max-w-[1350px] mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <ScrollSlideSection direction="up" className="mb-10 text-left">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[2.6rem] font-normal tracking-tight text-slate-900 dark:text-white mb-2">
