...
export default function Contact() {
  ...
  return (
    <div className="bg-transparent text-slate-900 dark:text-slate-50 min-h-screen pt-36 pb-20 relative overflow-hidden transition-colors duration-300">
      <ParticleWave />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 dark:text-white mb-6">
            <AnimatedHeroText text="Get in Touch with Our Engineers" />
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          {/* CONTACT INFO CARD */}
          <div className="lg:col-span-5 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-slate-200 dark:border-slate-800 rounded-3xl p-8 flex flex-col gap-8 shadow-xl">
            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Direct Channels</h3>
            
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl bg-sky-50 dark:bg-slate-800 text-sky-600 border border-sky-200 dark:border-slate-700 flex items-center justify-center shrink-0">
                <Phone className="w-6 h-6" />
              </div>
              <div>
                <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Phone / WhatsApp</h4>
                <a href="tel:+919360804323" className="text-lg font-bold text-slate-900 dark:text-white hover:text-sky-500 transition-colors">
                  +91 93608 04323
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl bg-rose-50 dark:bg-slate-800 text-rose-600 border border-rose-200 dark:border-slate-700 flex items-center justify-center shrink-0">
                <Mail className="w-6 h-6" />
              </div>
              <div>
                <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Email Inquiry</h4>
                <a href="mailto:vasukip2004@gmail.com" className="text-lg font-bold text-slate-900 dark:text-white hover:text-sky-500 transition-colors">
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl bg-emerald-50 dark:bg-slate-800 text-emerald-600 border border-emerald-200 dark:border-slate-700 flex items-center justify-center shrink-0">
                <MapPin className="w-6 h-6" />
              </div>
              <div>
                <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Location</h4>
                <p className="text-lg font-bold text-slate-900 dark:text-white">Tamil Nadu, India</p>
              </div>
            </div>
          ...
          {/* CONTACT FORM */}
          <div className="lg:col-span-7 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-slate-200 dark:border-slate-800 rounded-3xl p-8 sm:p-10 shadow-xl">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-xs font-bold text-slate-700 dark:text-slate-400 mb-2 uppercase">Full Name *</label>
                    <input 
                      type="text"
                      required
                      value={formData.name}
